          ...
          <View style={styles.ModalContainer}>
            <View style={styles.ModalView}>
              <ScrollView>
                ...
                ) : [DreamInterPretationText1.dreamName1] != null ? (
                  <>
                    <Text style={styles.modalTexthead}>ฝันเห็น{DreamInterPretationText.dreamName}</Text>
                    <Text style={styles.modalText}>{DreamInterPretationText.meaning}</Text>
                ...
                ) : (<Text style={styles.modalText}>ไม่พบคำสำคัญใดๆ</Text>)
                }
              </ScrollView>
            </View>
          </View>
      ...
      >
        ...
        <View style={styles.box7}>
          <View style={styles.box6}>
            ...
            <Image
              source={require('./Im/ทำนายฝัน-01.png')}
